...
type MultiHelloRequest struct {
	...
	// responses.
	SleepSeconds uint32 `protobuf:"varint,3,opt,name=sleep_seconds,json=sleepSeconds,proto3" json:"sleep_seconds,omitempty"`
}

func (x *MultiHelloRequest) Reset() {
	*x = MultiHelloRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MultiHelloRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MultiHelloRequest) ProtoMessage() {}

func (x *MultiHelloRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greeter_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MultiHelloRequest.ProtoReflect.Descriptor instead.
func (*MultiHelloRequest) Descriptor() ([]byte, []int) {
	return file_greeter_proto_rawDescGZIP(), []int{2}
}

func (x *MultiHelloRequest) GetRequest() *HelloRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *MultiHelloRequest) GetQty() uint32 {
	if x != nil {
		return x.Qty
	}
	return 0
...
func (x *MultiHelloRequest) GetSleepSeconds() uint32 {
	if x != nil {
...
var file_greeter_proto_rawDesc = []byte{
	...
	,
...
var file_greeter_proto_goTypes = []interface{}{
	...
	(*MultiHelloRequest)(nil), // 2: MultiHelloRequest
}
var file_greeter_proto_depIdxs = []int32{
	0, // 0: MultiHelloRequest.request:type_name -> HelloRequest
	0, // 1: Greeter.Greet:input_type -> HelloRequest
	2, // 2: Greeter.GreetMany:input_type -> MultiHelloRequest
	1, // 3: Greeter.Greet:output_type -> HelloReply
	1, // 4: Greeter.GreetMany:output_type -> HelloReply
...
func file_greeter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greeter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MultiHelloRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
